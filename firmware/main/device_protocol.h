...
#define DEVICE_PROTOCOL_FOLLOW_UP_WINDOW_SECONDS_MIN 3
#define DEVICE_PROTOCOL_FOLLOW_UP_WINDOW_SECONDS_MAX 8
#define DEVICE_PROTOCOL_FOLLOW_UP_WINDOW_SECONDS_DEFAULT 8
...
typedef enum {
    ...
    DEVICE_VOICE_STAGE_FOLLOW_UP_LISTENING,
    ...
    DEVICE_VOICE_STAGE_CONVERSATION_ENDED,
